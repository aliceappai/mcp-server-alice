...
### Added
- Added v2 tools in metadata.
- Added legacy tool names for compatibility clarity.

### Changed
- README tool docs updated to recommend v2 and separate legacy section.
- `server.json` version bump to `1.1.0`.
